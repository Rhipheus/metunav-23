...
def generate_launch_description():
    ...
    pkg_rover_localization = get_package_share_directory("metu_localization")
    pkg_rover_navigation = get_package_share_directory("metu_navigation")

    gazebo_params_file =os.path.join(
        pkg_path,
        "config",
        "gazebo_params_file.yaml")
