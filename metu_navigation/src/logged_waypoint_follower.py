...
#PROVIDED LOGGED_WAYPOINT_FOLLOWER REQUIRES IRON OR NEWER. FOR HUMBLE OR OLDER BELOW ISSUE IS SUGGESTED. FOXY'DEN GECMEYE DE COK GEREK YOKMUS AMK O KADAR UGRASTIM.

#https://github.com/ros-planning/navigation2_tutorials/issues/77
...
def main():
    ...
    default_yaml_file_path = os.path.join(get_package_share_directory(
        "metu_navigation"), "config", "waypoints.yaml")
    if len(sys.argv) > 1:
