...
def generate_launch_description():
    ...
    cmd_vel_topic_cmd = DeclareLaunchArgument(
        "cmd_vel_topic",
        default_value="/diff_controller/cmd_vel_unstamped",
    ...
    #BU KISIM ANLAMADIĞIM BİR ŞEKİLDE ÇALIŞMIYOR! bringup.launch.py'da hardcoded şekilde doğrusu verildi.
    ...
    lifecycle_nodes = ["controller_server",
                       "planner_server",
                       "behavior_server",#recoveries_server
                       "bt_navigator",
                       "waypoint_follower"]
